...
echo '<link rel="stylesheet" href="'.$config['home'].'/themes/night_city/night_city.css" type="text/css" />';
...
echo '<div class="a" id="up"><br /><img src="'.$config['home'].'/themes/night_city/site/logo.png" alt="image" /><br /><br />'.$config['logos'].'<br /><br /></div>';
