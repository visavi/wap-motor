...
echo '<div class="form" id="form"><form action="hi.php?action=hi&amp;'.SID.'" method="post">';
...
echo'<br /><img src="../images/img/faq.gif" alt="image" /> <a href="hi.php?action=faq&amp;'.SID.'">Правила</a>';
}
...
echo '<img src="../images/img/back.gif" alt="image" /> <a href="hi.php?'.SID.'">Вернуться</a>'; 	
}
