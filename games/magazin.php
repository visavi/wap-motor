...
echo '<img src="../images/weapon/kat_lite.gif" alt="image" /> <b><a href="magazin.php?action=lite">Легкое оружие</a></b> (4)<br />';
echo '<img src="../images/weapon/kat_pistols.gif" alt="image" /> <b><a href="magazin.php?action=pistols">Пистолеты</a></b> (5)<br />';

//echo '<img src="../images/weapon/kat_shotguns.gif" alt="image" /> <b><a href="magazin.php?action=shotguns">Ружья</a></b> (2)<br />';
echo '<img src="../images/weapon/kat_shotguns.gif" alt="image" /> <b>Ружья</b> (0)<br />';

//echo '<img src="../images/weapon/kat_smg.gif" alt="image" /> <b><a href="magazin.php?action=smg">Пистолеты-автоматы</a></b> (5)<br />';
echo '<img src="../images/weapon/kat_smg.gif" alt="image" /> <b>Пистолеты-автоматы</b> (0)<br />';

//echo '<img src="../images/weapon/kat_assault.gif" alt="image" /> <b><a href="magazin.php?action=assault">Автоматы</a></b> (5)<br />';
echo '<img src="../images/weapon/kat_assault.gif" alt="image" /> <b>Автоматы</b> (0)<br />';

//echo '<img src="../images/weapon/kat_rifles.gif" alt="image" /> <b><a href="magazin.php?action=rifles">Винтовки</a></b> (6)<br />';
echo '<img src="../images/weapon/kat_rifles.gif" alt="image" /> <b>Винтовки</b> (0)<br />';

//echo '<img src="../images/weapon/kat_grenades.gif" alt="image" /> <b><a href="magazin.php?action=grenades">Гранаты</a></b> (4)<br />';
echo '<img src="../images/weapon/kat_grenades.gif" alt="image" /> <b>Гранаты</b> (0)<br />';

//echo '<img src="../images/weapon/kat_ammo.gif" alt="image" /> <b><a href="magazin.php?action=ammo">Амуниция</a></b> (4)<br />';
...
echo '<img src="../images/weapon/kastet.gif" alt="image" /> <b><a href="magazin.php?action=shop&amp;weapon=kastet">Кастет</a></b> ('.moneys(100).')<br />';
...
echo '<img src="../images/weapon/knife.gif" alt="image" /> <b><a href="magazin.php?action=shop&amp;weapon=knife">Охотничий нож</a></b> ('.moneys(200).')<br />';
echo 'Обыкновенный нож, с которым ходят на охоту<br />';
echo '<b>(Вес: 350гр, урон +2%)</b><br /><br />';

echo '<img src="../images/weapon/knife2.gif" alt="image" /> <b><a href="magazin.php?action=shop&amp;weapon=knife2">Армейский нож</a></b> ('.moneys(300).')<br />';
...
echo '<img src="../images/weapon/bita.gif" alt="image" /> <b><a href="magazin.php?action=shop&amp;weapon=bita">Бита</a></b> ('.moneys(500).')<br />';
...
echo '<br /><img src="../images/img/back.gif" alt="image" /> <a href="magazin.php">Вернуться</a>';
}
...
echo '<img src="../images/weapon/glock18.gif" alt="image" /> <b><a href="magazin.php?action=shop&amp;weapon=glock18">Glock18</a></b> ('.moneys(1000).')<br />';
...
echo '<img src="../images/weapon/usp.gif" alt="image" /> <b><a href="magazin.php?action=shop&amp;weapon=usp">USP Tactical</a></b> ('.moneys(2000).')<br />';
...
echo '<img src="../images/weapon/p228.gif" alt="image" /> <b><a href="magazin.php?action=shop&amp;weapon=p228">P228</a></b> ('.moneys(2500).')<br />';
...
echo '<img src="../images/weapon/fiveseven.gif" alt="image" /> <b><a href="magazin.php?action=shop&amp;weapon=fiveseven">Five-Seven</a></b> ('.moneys(3000).')<br />';
echo 'Очень хороший пистолет, имеет хорошую кучность, скорострельность<br />';
echo '<b>(Магазин: 20, Вес: 600гр, урон +7%)</b><br /><br />';

echo '<img src="../images/weapon/elites.gif" alt="image" /> <b><a href="magazin.php?action=shop&amp;weapon=elites">Dual Beretta</a></b> ('.moneys(5000).')<br />';
