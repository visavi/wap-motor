...
echo '<b><a href="naperstki.php?action=choice">Играть</a></b><br /><br />';
echo 'У вас в наличии: '.moneys($udata[41]).'<br />';
echo '<br /><img src="../images/img/faq.gif" alt="image" /> <a href="naperstki.php?action=faq">Правила</a><br />';
}
...
echo '<a href="naperstki.php?action=go&amp;thimble=1&amp;rand='.$rand.'"><img src="../images/naperstki/2.gif" alt="image" /></a> ';
echo '<a href="naperstki.php?action=go&amp;thimble=2&amp;rand='.$rand.'"><img src="../images/naperstki/2.gif" alt="image" /></a> ';
echo '<a href="naperstki.php?action=go&amp;thimble=3&amp;rand='.$rand.'"><img src="../images/naperstki/2.gif" alt="image" /></a>.<br /><br />';

echo 'Выберите наперсток в котором может находится шарик<br />';

echo 'У вас в наличии: '.moneys($udata[41]).'<br />';

echo '<br /><img src="../images/img/back.gif" alt="image" /> <a href="naperstki.php">Вернуться</a><br />';
}
...
echo '<br /><b><a href="naperstki.php?action=choice&amp;rand='.$rand.'">К выбору</a></b><br /><br />';
