...
echo 'Разместил: <a href="../pages/anketa.php?uz='.$data[4].'"> '.nickname($data[4]).' </a><br />';
echo '<a href="komm.php?id='.(int)$data[5].'">Комментарии</a> ';
...
echo '<br /><br /><img src="../images/img/rss.gif" alt="image" /> <a href="rss.php">RSS подписка</a><br />';
