...
echo '<b><a href="index.php?action=showimg&amp;gid='.$dt[6].'&amp;start='.$start.'&amp;'.SID.'">'.$dt[1].'</a></b> ('.$filesize.')</div><div>';

echo '<a href="index.php?action=showimg&amp;gid='.$dt[6].'&amp;start='.$start.'&amp;'.SID.'"><img src="resize.php?name='.$dt[6].'" alt="image" /></a>';
...
echo '<br /><img src="../images/img/back.gif" alt="image" /> <a href="index.php?start='.$start.'&amp;'.SID.'">Вернуться</a>'; 
}
...
echo '<form action="index.php?action=add&amp;'.SID.'" method="post" name="form" enctype="multipart/form-data">';
...
header ("Location: index.php?isset=addfoto&".SID); exit;
...
echo '<br /><img src="../images/img/back.gif" alt="image" /> <a href="index.php?action=addfoto&amp;'.SID.'">Вернуться</a>'; 
}
...
echo '<form action="index.php?action=addkomm&amp;gid='.$gid.'&amp;'.SID.'" method="post">';
...
header("location: index.php?action=komm&gid=$gid&isset=addkomm&".SID); exit;
...
echo '<img src="../images/img/reload.gif" alt="image" /> <a href="index.php?'.SID.'">В галерею</a>';
}
...
header("location: index.php?action=komm&gid=$gid&start=$start&isset=delkomm&".SID); exit;
...
echo '<br /><img src="../images/img/back.gif" alt="image" /> <a href="index.php?action=komm&amp;gid='.$gid.'&amp;start='.$start.'&amp;'.SID.'">Вернуться</a>';
}
