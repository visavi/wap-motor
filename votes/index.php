...
echo '<form action="vote.php?action=vote" method="post">';
...
echo '<br /><img src="../images/img/reload.gif" alt="image" /> <a href="vote.php">Посмотреть результаты</a>';

} else {echo '<b>Голосование еще не создано</b><br />';}

echo '<br /><img src="../images/img/arhiv.gif" alt="image" /> <a href="allvotes.php">Архив голосований</a><br />';
