...
echo '<br /><img src="../images/img/error.gif" alt="image" /> <a href="../input.php?action=exit">Выход</a>';
}
...
echo '<b><img src="../images/img/reload.gif" alt="image" /> <a href="../index.php">Вход на сайт!</a></b><br />';
...
echo '<br /><img src="../images/img/back.gif" alt="image" /> <a href="key.php">Вернуться</a>';
}}
