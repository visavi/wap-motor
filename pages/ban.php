...
echo '<br /><br />Чтобы не терять время зря, рекомендуем вам ознакомиться с <b><a href="'.BASEDIR.'pages/pravila.php">Правилами сайта</a></b><br />';
...
echo '<br /><form method="post" action="ban.php?action=send">';
echo 'Объяснение:<br />';
...
header ("Location: ban.php?isset=addbansend"); exit;
...
echo '<br />Рекомендуем ознакомиться с <b><a href="'.BASEDIR.'pages/pravila.php">Правилами сайта</a></b><br />';

echo 'Также у вас есть возможность исправиться и снять строгое нарушение.<br />';
echo 'Если прошло более 1 месяца после последнего бана, то на странице <b><a href="'.BASEDIR.'pages/razban.php">Исправительная</a></b> заплатив штраф вы можете снять 1 строгое нарушение<br />';
