...
echo '<form action="raitinglist.php?start='.$start.'&amp;'.SID.'" method="post">';
...
if ($start!=$stranica){ 
header ("Location: raitinglist.php?start=$stranica&uz=$uz&".SID);  exit;
}
...
echo '<br /><a href="raitinglist.php?start='.$start.'&amp;'.SID.'">Искать еще</a><br />';
