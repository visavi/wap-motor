...
$statforum = stats_forum();
$dataforum = explode('/', $statforum);

echo 'Тем в форуме: <b>'.(int)$dataforum[0].'</b><br />';
echo 'Записей в форуме: <b>'.(int)$dataforum[0].'</b><br />';
...
echo 'E-mail в черном списке: <b>'.stats_blackmail().'</b><br /><br />';
