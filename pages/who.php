...
echo '<div class="b"><img src="../images/img/chel.gif" alt="image" /> <b><a href="../pages/anketa.php?uz='.$data[0].'&amp;'.SID.'">'.nickname($data[0]).'</a></b> ('.$tm.')</div>';
...
echo'<br /><br /><img src="../images/img/homepage.gif" alt="image" /> <a href="../index.php?'.SID.'">На главную</a>';
