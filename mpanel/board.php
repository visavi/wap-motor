...
if ($is_admin) {echo '<form action="board.php?action=delrub&amp;uid='.$_SESSION['token'].'&amp;'.SID.'" method="post">';}
...
echo '<b><a href="board.php?action=board&amp;id='.$data[2].'&amp;'.SID.'">'.$data[0].'</a></b> ('.(int)$totalboard.')';

if ($is_admin){
echo '<br /><input type="checkbox" name="del[]" value="'.$key.'" /> ';

if ($key != 0){echo '<a href="board.php?action=move&amp;id='.$key.'&amp;where=0&amp;uid='.$_SESSION['token'].'&amp;'.SID.'">Вверх</a> | ';} else {echo 'Вверх | ';}
if ($total > ($key+1)){echo '<a href="board.php?action=move&amp;id='.$key.'&amp;where=1&amp;uid='.$_SESSION['token'].'&amp;'.SID.'">Вниз</a>';} else {echo 'Вниз';}
echo ' | <a href="board.php?action=edit&amp;id='.$key.'&amp;'.SID.'">Редактировать</a>';
}
...
if ($is_admin) {echo '<br /><img src="../images/img/edit.gif" alt="image" /> <a href="board.php?action=add&amp;'.SID.'">Добавить</a>';}
}
...
echo 'Автор объявления: <a href="../pages/anketa.php?uz='.$data[1].'&amp;'.SID.'">'.nickname($data[1]).'</a>';
echo '</div>';	
...
echo '<br /><img src="../images/img/back.gif" alt="image" /> <a href="board.php?'.SID.'">Вернуться</a>';
}
...
echo '<form action="board.php?action=addrub&amp;uid='.$_SESSION['token'].'&amp;'.SID.'" method="post">';
...
echo '<img src="../images/img/back.gif" alt="image" /> <a href="board.php?'.SID.'">Вернуться</a>';
}
...
header ("Location: board.php?isset=mp_addboard&".SID); exit;
...
echo '<br /><img src="../images/img/reload.gif" alt="image" /> <a href="board.php?action=add&amp;'.SID.'">Вернуться</a><br />';
echo '<img src="../images/img/back.gif" alt="image" /> <a href="board.php?'.SID.'">К объявлениям</a>';
}
...
echo '<form action="board.php?id='.$id.'&amp;action=addedit&amp;uid='.$_SESSION['token'].'&amp;'.SID.'" method="post">';
...
header ("Location: board.php?isset=mp_editboard&".SID); exit;
...
header ("Location: board.php?isset=mp_moveboard&".SID); exit;
...
header ("Location: board.php?isset=mp_delboard&".SID); exit;
...
header ("Location: board.php?action=board&id=$id&start=$start&isset=mp_deltopboard&".SID); exit;
...
echo '<br /><img src="../images/img/back.gif" alt="image" /> <a href="board.php?action=board&amp;id='.$id.'&amp;start='.$start.'&amp;'.SID.'">Вернуться</a>';
}
