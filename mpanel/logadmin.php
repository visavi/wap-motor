...
echo '<div class="b">';
echo '<img src="../images/img/files.gif" alt="image" /> <b><a href="../pages/anketa.php?uz='.$dtlog[3].'">'.nickname($dtlog[3]).'</a></b>';
...
echo '<br /><br /><img src="../images/img/error.gif" alt="image" /> <a href="logadmin.php?action=del&amp;uid='.$_SESSION['token'].'">Очистить логи</a>';}
...
header ("Location: logadmin.php?isset=mp_dellogs"); exit;
...
echo '<br /><img src="../images/img/back.gif" alt="image" /> <a href="logadmin.php">Вернуться</a>';
}
