...
if($msg==101){$status='Господин ПЖ';}
elseif($msg==102){$status='Абрадокс';}
elseif($msg==103){$status='Старший Эцилопп';}
elseif($msg==105){$status='Эцилопп';}
else{$status='Пришелец';}
return $status;
}	
...
if($data[7]==101){$title='<span style="color:#0000ff">[Господин ПЖ]</span>';}
if($data[7]==102){$title='<span style="color:#0000ff">[Абрадокс]</span>';}
if($data[7]==103){$title='<span style="color:#ff8000">[Старший Эцилопп]</span>';}
if($data[7]==105){$title='<span style="color:#ff8000">[Эцилопп]</span>';}
return $title;
}}
}
...
echo '<img src="'.BASEDIR.'images/img/error.gif" alt="image" /> <b>'.$error.'</b><br />';
}
